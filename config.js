module.exports = {
  OWNER_IDS: [900781680242073681, 563745833120432150], // Bot owner ID's
  PREFIX: "}", // Default prefix for the bot
  SUPPORT_SERVER: "https://discord.gg/xMmwnUxcKy", // Your bot support server
  PRESENCE: {
    ...
    MESSAGE: "Sadie Sink<33", // Your bot status message
  },
  DASHBOARD: {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "957253363160993863", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  XP_SYSTEM: {
    COOLDOWN: 5, // Cooldown in seconds between messages
    DEFAULT_LVL_UP_MSG: "{m}, Właśnie zdobyłes **Level {l}**!",
  },
  MISCELLANEOUS: {
